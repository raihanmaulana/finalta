        ...
        <div class="module">
            ...
            <div class="row">
                <div class="module-body column">
                    <h2 style="text-align:center;">School Branches</h2>
                    <form class="form-horizontal row-fluid">

                        <div class="control-group">
                            <label class="control-label">Branch Name</label>
                            <div class="controls">
                                <input type="text" id="branch" data-form-field="branch"
                                    placeholder="Enter branch here..." class="span12">
                                    ...
                                    <td>
                                        <div class="btn btn-group">
                                            ...
                                            <a href="#" data-toggle="modal"
                                                data-target="#deleteBranch{{ $branch->id }}"><i
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{ route('student.destroy', $branch->id) }}" method="Post">
                                                    @csrf
                                                    @method('Delete')
                                                    <p>Are you sure you want to delete this ({{ $branch->branch }}) Branch ?
                                                    </p>
                ...
                <div class="module-body column">
                    <h2 style="text-align:center;">Student Categories</h2>
                    <form class="form-horizontal row-fluid">
                        <div class="control-group">
                    ...
                    <table class="table table-striped" style="margin-left: 30px">
                        ...
                        <tbody>
                            @foreach ($student_category as $student_category)
                                ...
                                <!-- Modal -->
                                <div class="modal fade" id="deleteCategory{{ $student_category->cat_id }}"
