                    ...
                    <table class="table table-striped table-bordered table-condensed">
                        <thead>
                            <tr>
                                ...
                                <th class="hide-on-small">Nama Anggota</th>
                                <th>Judul Buku</th>
                        ...
                        <tbody>
                            ...
                            @forelse($riwayatPeminjaman as $index => $peminjaman)
                                <tr>
                                    ...
                                    <td class="hide-on-small">{{ $peminjaman->anggota->nomor_anggota ?? 'Default Name' }}
                                    </td>
                                    <td class="hide-on-small">{{ $peminjaman->anggota->nama_anggota ?? 'Default Name' }}</td>
