        ...
        <div class="module">
            ...
            <div class="module-body">
                <table class="table table-bordered table-condensed">
                    <tbody>
                        <tr>
                            <td style="width: 200px; text-align: center;"><img src="{{ asset('storage/' . $user->gambar) }}"
                                    alt="Foto Profil" style="width:150px; height:200px;">
                            </td>
                            <td>
                ...
                <div class="row">
                    <a href="{{ route('edit_profil', $user->id_anggota) }}" class="btn btn-inverse pull-right"
