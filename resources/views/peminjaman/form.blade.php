        ...
        <div class="btn-controls">
            ...
            <div class="content">
                <div class="module" style="display: none;">
                    <div class="module-body">
                        <form class="form-horizontal row-fluid" method="post"
                            action="{{ route('bukutamu_anggota.store') }}"id="bukutamuform">
                            @csrf
                            <div class="control-group">
                                <label class="control-label" for="nomor_anggota">Nomor Anggota<br></label>
                                <div class="controls">
                                    <div class="span9">
                                        <input class="span12" type="text" name="nomor_anggota" id="nomor_anggota"
                                            placeholder="Masukkan Nomor Anggota Anda"></input>
                                    </div>
                                    <div class="span3">
                                        <button type="submit" class="btn homepage-form-submit "
                                            style="background-color:  #025E9B; color:#fff">
                                            Masuk</button>
                                    </div>
                                </div>
                        ...
                        <form class="form-horizontal row-fluid" id="findbookform">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <div class="span3">
                                        <a class="btn homepage-form-submit "
                                            style="background-color:  #025E9B; color:#fff"><i class="icon-search"></i>
                                            Cari</a>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="module" style="display: none;">
                    <div class="module-body">
                        <form class="form-horizontal row-fluid" method="post"
                            action="{{ route('peminjaman.pinjam') }}"id="pinjambukuform">
                            @csrf
                            ...
                            <hr>
                            <button class="btn homepage-form-submit"
                                style="background-color:  #025E9B; color:#fff"type="submit">Pinjam Buku</button>
                        </form>
                        @if (session('success'))
