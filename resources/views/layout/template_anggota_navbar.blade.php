<div class="navbar navbar-fixed-top">
    <div class="navbar-inner">
        <div class="container" style="align-items: center; display: flex; justify-content: space-between">
            ...
            <a class="brand" href="{{ URL::route('anggota.dashboard') }}" style="color:#000000; font-weight:500; margin-right: auto;"><img src="{{ asset('css/images/logo.png') }}" alt="Bootstrap" width="40" height="auto" />
