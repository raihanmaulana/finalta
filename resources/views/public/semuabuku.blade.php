                        ...
                        <ul class="main-categories">
                            <li class="main-nav-list"><a data-toggle="collapse" href="#fruitsVegetable"
                                ...
                                <ul class="collapse" id="fruitsVegetable" data-toggle="collapse" aria-expanded="false"
                                    ...
                                    <li class="main-nav-list child"><a href="#">Umum<span
                                                class="number">(13)</span></a>
                                    </li>
                                    <li class="main-nav-list child"><a href="#">Sains<span
                                                class="number">(09)</span></a>
                                    </li>
                                    <li class="main-nav-list child"><a href="#">Agama<span
                                                class="number">(17)</span></a>
                                    </li>
                                    <li class="main-nav-list child"><a href="#">Bahasa<span
                                                class="number">(01)</span></a>
                                    </li>
                                    <li class="main-nav-list child"><a href="#">Sejarah<span
                            ...
                            <li class="main-nav-list"><a data-toggle="collapse" href="#officeProduct"
                                    aria-expanded="false" aria-controls="officeProduct"><span
                                        class="lnr lnr-arrow-right"></span>Sejarah<span class="number">(77)</span></a>
