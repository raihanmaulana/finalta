                ...
                <ul class="main-categories">
                    <li class="main-nav-list"><a data-toggle="collapse" href="#fruitsVegetable" aria-expanded="false"
                        ...
                        <ul class="collapse" id="fruitsVegetable" data-toggle="collapse" aria-expanded="false"
                            ...
                            <li class="main-nav-list child"><a href="#">Agama<span class="number">(17)</span></a></li>
                            <li class="main-nav-list child"><a href="#">Bahasa<span class="number">(01)</span></a></li>
                            <li class="main-nav-list child"><a href="#">Sejarah<span class="number">(11)</span></a></li>
                        </ul>
                    </li>
