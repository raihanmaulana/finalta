                ...
                <div class="card-body">
                    ...
                    <form class="row g-3" method="POST" action="{{ route('anggota.register') }}">
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control" name="nama_anggota" id="nama_anggota" value="{{ old('nama_anggota') }}" required>
                        </div>
                        <div class="col-6">
                            <label for="nomor_anggota" class="form-label">Nomor Anggota</label>
                            <input type="text" class="form-control" name="nomor_anggota" id="nomor_anggota" value="{{ old('nomor_anggota') }}" required>
                        </div>
                        <div class="col-6">
                        ...
                        <div class="col-6">
                            ...
                            <input type="text" class="form-control" name="nomor_hp" id="nomor_hp" value="{{ old('nomor_hp') }}" required>
                        </div>
                        <div class="col-6">
                        ...
                        <div class="col-12">
                            <button type="submit" class="btn btn-dark btn-lg btn-block content-card full-width-button">Daftar</button>
                        </div>
                        <div class="mt-3 text-center content-card">
                            Sudah memiliki akun?
                            <a class="content-card" href="{{ URL::route('anggota.login') }}" style="text-decoration: none;">Masuk</a>
                        </div>
