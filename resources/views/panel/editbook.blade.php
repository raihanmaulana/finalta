    ...
    <div class="content">
        <div class="module">
            ...
            <div class="module-body">
                <form id="editBooksForm" class="form-horizontal row-fluid" method="POST"
                    action="{{ route('books.update', $book->id_buku) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" id="tautan_buku" name="tautan_buku" value="{{ $book->tautan_buku }}"
                                class="span8">
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        <div class="controls">
                            <button type="submit" class="btn btn-inverse"
                                onclick="editBuku({{ $book->id_buku }})">Simpan</button>
