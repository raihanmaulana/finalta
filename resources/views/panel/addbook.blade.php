            ...
            <div class="module-body">
                <form class="form-horizontal row-fluid" method="POST" action="{{ route('book.store') }}"
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="nomor_buku" id="nomor_buku" placeholder="Masukkan ISBN"
                                class="span8">
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="pengarang" id="pengarang" placeholder="Masukkan Nama Pengarang"
                                class="span8">
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="tahun_terbit" id="tahun_terbit" placeholder="Masukkan Tahun Terbit"
                                class="span8">
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select tabindex="1" name="kategori_id" id="kategori_id" data-placeholder="Select kategori.."
                                class="span8">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="stok" id="stok" placeholder="Masukkan Stok Buku"
                                class="span8">
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        <div class="controls">
                            <button type="submit" class="btn btn-inverse span2" id="addbooks">Add Books</button>
