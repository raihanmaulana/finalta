                ...
                <div class="controls">
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <input type="text" id="searchInput" onkeyup="searchBooks()"
                            placeholder="Cari berdasarkan judul buku atau nomor buku" style="width: 45%;">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="center-block"
                                            ...
                                            <button class="btn btn-info edit-btn" style="margin-bottom: 2px; width: 75px;"
                                            ...
                                            @if ($book->kondisi == 1)
                                                <form action="{{ route('books.deactivate', $book->id_buku) }}"
                                                    method="POST">
                                                    @csrf
