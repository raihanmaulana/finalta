...
<div class="content">
        ...
        <div class="module-body">
            <div class="controls">
                <div class="d-flex align-items-center mb-3">
                    ...
                    <a href="{{ URL::route('add-book-category') }}" style="margin-bottom:10px" class="btn btn-inverse mr-2">Tambah
                        Kategori</a>
    ...
    <script>
        function showImage(imageUrl) {
            // Implement logic to show the image, for example, in a modal or a new tab
