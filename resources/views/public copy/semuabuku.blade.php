...
<div <!-- header -->
    ...
    functio            tail(bu                    const detailCard = document.get            yId("detail                    detai        d.s        .display = "        k";         }

        // Fungsi        uk menyembunyikan card d               uku
        function hideDet                    const detai            document.getElementById("detail                            detailCard.style.display =         e               }
    ...
    f            searchBo                    // Ambil nilai input pe                    var sear            = document.getElement            archInput').value.toLowerC                               Ambil daft                    var        ks = {
        ...
        /             buku berdasarka        dul
        var filteredBooks = books.fi(func(                    return         .judul_buku.toLowerCase().includes(s        h        y);
         );
    ...
    displayB            teredBooks);         }
        ...
        function displayBooks(b                        var bookListContainer = documen            mentById('book                                  ntainer.innerHTML                    // Tampilkan buku yang telah d                    books.forEach(function (                        var html = `
            < div class="col-6 col-md-4 col-lg-2" >
                <div class="card h-100">
                    <img src="${book.image ? asset('storage/' + book.image) : 'img/130x190.png'}" class="card-img-top mt-3 mx-auto" alt="Book Image" data-bs-toggle="modal" data-bs-target="#detailModal${book.id_buku}">
                        <div class="card-body text-center">
                            <h6 class="card-title">${book.judul_buku}</h6>
                            <button class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#detailModal${book.id_buku}" onclick="showBookDetai                d_buku}')">Detail</button>
                            div                          </div>
